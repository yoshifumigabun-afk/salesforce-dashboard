...
async function testGroup() {
    ...
    // We assign explicit aliases (pName, sName) to avoid duplicate 'Name' error
    const soql = `
    SELECT 
        ...
        PhotographingInformation__r.Photographer__r.Name pName,
        PhotographingInformation__r.Selector__r.Name sName,
        MajorDivisions__c,
        Broad_division__c,
